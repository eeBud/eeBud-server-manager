...
<body>
    <div class="FondCouleur">
        ...
        <h2 class="SousTitre">Paramètres</h2>
        <br>
    </div>
        ...
        <div class="FondCouleur">
            ...
            <div class="FondCouleur">
                ...
                <div class="FondBlanc">
                    ...
                    </span> <button class="Bouton" onclick="window.location.href = '/load?nav=saveParams';" style="text-decoration:none">
    ...
    <script> 
      function ClickToogle(toogle,element) {        
        if (toogle.checked) {
          document.getElementById(""+element+"").value = "1";
          document.getElementById("Value"+element+"").innerHTML = "Actif";          
        }else{          
          document.getElementById(""+element+"").value = "0";
          document.getElementById("Value"+element+"").innerHTML = "Inactif";          
        }
      }
    </script>
</body>
